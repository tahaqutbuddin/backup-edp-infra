...
variable "aci_img" {
  default = "attedpdacr01dbttst001.azurecr.io/attedpdarepoacrsn:latest"
}
...
variable "vnet_address" {
  default = ["10.104.0.0/23"] 
}
variable "snet_address" {
  default = ["10.104.0.0/28"]
}
variable "aci_snet_address" {
  default = ["10.104.0.16/28"] 
}
...
variable "log_analytics_name" {
  default = "att-edp-da-la01-tst"
}
variable "logs_storage_account_name" {
  default = "attedpdadlslogs01tst"
}
