...
variable "aci_img" {
  default = "attedpdacr01dbtdev001.azurecr.io/attedpdarepoacrsn:latest"
}
...
variable "rawalds_st_dns" {
  default = "raw.privatelink.blob.core.windows.net"
}
...
variable "lndalds_st_dns" {
  default = "lnd.privatelink.blob.core.windows.net"
}
